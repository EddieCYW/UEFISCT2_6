...
typedef struct EFI_SIMPLE_TEXT_IN_PROTOCOL EFI_SIMPLE_TEXT_INPUT_PROTOCOL;
typedef struct EFI_SIMPLE_TEXT_OUT_PROTOCOL EFI_SIMPLE_TEXT_OUTPUT_PROTOCOL;
...
typedef struct {
  ...
  SCT_LIST_ENTRY            Link;                 ///< Linked list helper.
...
/**
  ...
  SCT_LIST_ENTRY linked list structure.  Use this in conjunction with the
...
typedef struct {
  ...
  SCT_LIST_ENTRY              Link;        ///< Standard linked list helper member.
  //
