...
[BuildOptions]
  MSFT:*_*_IA32_CC_FLAGS    = /D EFI_SPECIFICATION_VERSION=0x00020028 /D TIANO_RELEASE_VERSION=0x00080006 /D EFI32 /wd4133 /D MDE_CPU_IA32 /Od
  ...
  MSFT:*_*_X64_CC_FLAGS    = /D EFI_SPECIFICATION_VERSION=0x00020028  /D TIANO_RELEASE_VERSION=0x00080006 /D EFIX64 /wd4133 /D MDE_CPU_X64 /Od
  ...
  MSFT:*_*_IPF_CC_FLAGS    = /Od /D EFI_SPECIFICATION_VERSION=0x00020028 /D TIANO_RELEASE_VERSION=0x00080006 /D EFI64 /D MDE_CPU_IPF
  ...
  GCC:*_*_X64_CC_FLAGS     = -D EFIX64 $(GCC_VER_MACRO) -ffreestanding -nostdinc -nostdlib -Wno-error -DEFI_SPECIFICATION_VERSION=0x0002001F -mno-red-zone -Wno-address -mno-stack-arg-probe "-DEFIAPI=__attribute__((ms_abi))" -m64 -mcmodel=large -mabi=ms -D MDE_CPU_X64
...
# 177:  "function <static function> was declared but never referenced"
  ...
  *_*_AARCH64_CC_FLAGS         = -D EFIARM $(GCC_VER_MACRO)
  GCC:*_*_AARCH64_CC_FLAGS     = -D EFIARM $(GCC_VER_MACRO) -ffreestanding -nostdinc -nostdlib -Wno-error=unused-function -Wno-error=unused-but-set-variable -Wno-error
  *_*_AARCH64_VFRPP_FLAGS      = -D EFIARM $(GCC_VER_MACRO)
  *_*_AARCH64_APP_FLAGS        = -D EFIARM $(GCC_VER_MACRO)
  *_*_AARCH64_PP_FLAGS         = -D EFIARM $(GCC_VER_MACRO)
