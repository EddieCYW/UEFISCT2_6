...
[BuildOptions]
  ...
  *_*_ARM_CC_FLAGS = -D EFIARM
  GCC:*_*_ARM_CC_FLAGS  = -D EFIARM $(GCC_VER_MACRO) -ffreestanding -nostdinc -nostdlib -Wno-error=unused-function -Wno-error=unused-but-set-variable -Wno-error=implicit-function-declaration -Wno-error -fno-stack-protector
