...
EFI_GUID gEfiTcp4RegistryDataGuid           = EFI_TCP4_REGISTRY_DATA_GUID;
...
EFI_GUID_STRING (&gEfiTcp4RegistryDataGuid, "TCP4 Registry Data Format", "TCP4 Registry Data Format");