...
} BOOT_SERVICES_DRIVER_5_PRIVATE_DATA;

BOOT_SERVICES_DRIVER_5_PRIVATE_DATA   mPrivateData;
  ...
  )
{
  ...
  LoadedImageInfoPtr->Unload = BootServicesDriver5Unload;
