...
EFI_STATUS
BootServicesDriver4BindingSupported (
...
EFI_STATUS
BootServicesDriver4BindingStart (
  IN EFI_DRIVER_BINDING_PROTOCOL    *This,
  IN EFI_HANDLE                     Controller,
  IN EFI_DEVICE_PATH_PROTOCOL       *RemainingDevicePath
  );
...
EFI_STATUS
BootServicesDriver4BindingStop (
  IN  EFI_DRIVER_BINDING_PROTOCOL    *This,
  IN  EFI_HANDLE                     Controller,
  ...
  )
{
  ...
  LoadedImageInfoPtr->Unload = BootServicesDriver4Unload;
...
{
  DriverBinding->Supported            = BootServicesDriver4BindingSupported;
  DriverBinding->Start                = BootServicesDriver4BindingStart;
  DriverBinding->Stop                 = BootServicesDriver4BindingStop;
