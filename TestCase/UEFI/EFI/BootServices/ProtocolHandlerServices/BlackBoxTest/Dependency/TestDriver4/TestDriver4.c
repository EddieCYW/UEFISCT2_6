  ...
  )
{
  ...
  LoadedImageInfoPtr->Unload = TestDriver4Unload;
  ...
  mPrivateData->ExProt1.GetNextStatusReport = TestDriver4GetNextStatusReport;
  ...
  )
{
  ...
  PrivateData = TEST_DRIVER_4_PRIVATE_DATA_FROM_THIS (This);
